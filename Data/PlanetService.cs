...
namespace PlanetAtlas.Data
{
    public class PlanetService : IPlanetService
    {
        ...
        public bool AddPlanet(Planet newPlanet, out bool success)
        {
        ...
        public bool UpdatePlanet(string name, Planet editPlanet, out bool success)
        {
            var updatePlanet = 
                _planets.FirstOrDefault(p => p.Name == name);

            if (name == editPlanet.Name || 
